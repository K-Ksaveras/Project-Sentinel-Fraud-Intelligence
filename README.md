...
The Discovery: By applying BART-Large ZeroShot Classification to the textual disclosures of those same entities, the system identified clear indicators of "Internal Control Weaknesses" and "Compliance Concerns."
